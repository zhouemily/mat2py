...
# Read the DICOM file
dcm_file = 'd004/7T_STAB_12_8_2023.MR.SUTTON_SEQTESTING.0004.0256.2023.12.08.07.38.12.980291.186296403.IMA'
...
coeffs[1:] = [pywt.threshold(c, value=10, mode='soft') for c in coeffs[1:]]
wavelet_denoised = pywt.waverec2(coeffs, 'db1')
